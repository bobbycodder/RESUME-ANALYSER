...
st.markdown(
      ...
      <body>
      `<div>
        <h1 style="padding:13px;color:white;font-size:50px;text-align: center;top: 50%;left: 50%;font-family:sans-serif;" >Resume Analyser</h1>
            <h4 style="color:white;text-align: center;top: 50%;left: 50%;font-family:Papyrus;">You are Not Your Resume , You're your work.</h4>
            <h4 style="color:white;text-align: center;top: 50%;left: 50%; font-family:cursive;">~ Divyansh Modi</h4>
        </div>
      </body>
      """,
    unsafe_allow_html=True)

lottie_coding = load_lottiefile("Resume2.json",) 
st_lottie(lottie_coding,height=None,width=None,reverse=False,loop=True)
    ...
    if choice == "Normal User":
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                text = 'See our Skills recommendations',
        ...
        if st.button('Login'):
            if ad_user == 'Bobby15' and ad_password == '#Bobby@15':
